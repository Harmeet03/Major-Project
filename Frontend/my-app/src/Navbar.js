...
<div className="dropdown1">
<button className="dropbtn">Events <i className="fa fa-caret-down"></i></button>
<div className="dropdown-content">
<Link to="/Rumala">Rumala Sahib</Link>
<Link href="">Chattar Sahib</Link>
<Link href="">Chaur Sahib</Link>
...
<div className="dropdown1">
<button className="dropbtn">Pages <i className="fa fa-caret-down"></i></button>
<div className="dropdown-content">
<Link to="/Rumala">Rumala Sahib</Link>
<Link href="">Chattar Sahib</Link>
<Link href="">Chaur Sahib</Link>
...
<div className="dropdown1">
<button className="dropbtn">Elements <i className="fa fa-caret-down"></i></button>
<div className="dropdown-content">
<Link to="/Rumala">Rumala Sahib</Link>
<Link href="">Chattar Sahib</Link>
<Link href="">Chaur Sahib</Link>
