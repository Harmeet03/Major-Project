...
const SignIn = () => {
    ...
    const handleLogin = async (event) => {
        ...
        try {
          const response = await fetch('https://school-erp-system.onrender.com/slogin', {
            method: 'POST',
            headers: {
    ...
    return(
        ...
        <div className="si">
            ...
            <div className="right">
                <h1> SIGN IN </h1>
                <h3> <h2>Welcome Back STUDENT.</h2> Nice to see you again.<h4>Note: <span style={{fontSize: "22px"}}>Please contact admin or your respective teacher if you are unable to sign in.</span></h4> </h3>
            </div>
        </div>
        </>
    )
